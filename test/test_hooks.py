...
def test_pisa_custom_sand_mt():
    ...
    # plot same curve with custom pisa sand curve
    params = {'sig':50, 'G0':50e3, 'D':6, 'p':100, 'X_ult':funcs['mt_X'](5), 'Y_ult':funcs['mt_Y'](5), 'n':funcs['mt_n'](5), 'k':funcs['mt_k'](5)}
    y_custom, p_custom = custom_pisa_sand(**params)
...
def test_pisa_custom_clay_py():
    ...
    # plot same curve with custom pisa sand curve
    params = {'Su':75, 'G0':50e3, 'D':6, 'X_ult':funcs['py_X'](5), 'Y_ult':funcs['py_Y'](5), 'n':funcs['py_n'](5), 'k':funcs['py_k'](5)}
...
def test_pisa_custom_clay_mt():
    ...
    # plot same curve with custom pisa sand curve
    params = {'Su':75, 'G0':50e3, 'D':6, 'X_ult':funcs['mt_X'](5), 'Y_ult':funcs['mt_Y'](5), 'n':funcs['mt_n'](5), 'k':funcs['mt_k'](5)}
    y_custom, p_custom = custom_pisa_clay(**params)
